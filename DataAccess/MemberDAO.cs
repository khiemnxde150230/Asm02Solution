...
namespace DataAccess
{
    ...
    public class MemberDAO : BaseDAL
    {
        ...
        public MemberObject CheckLogin(string email, string password)
        {
            ...
            try
            {
                var emailParam = dataProvider.CreateParameter("@Email", 50, email, DbType.String);
                var passwordParam = dataProvider.CreateParameter("@Password", 50, password, DbType.String);
                dataReader = dataProvider.GetDataReader(SQLSelect, CommandType.Text, out connection, emailParam, passwordParam);
                if (dataReader.Read())
                {
        ...
        public void AddNew(MemberObject member)
        {
            try
            {
                ...
                if (pro == null)
                {
                    ...
                    parameters.Add(dataProvider.CreateParameter("@Country", 4, member.Country, DbType.String));
                    parameters.Add(dataProvider.CreateParameter("@Password", 4, member.Password, DbType.String));
